<h2><a href="https://leetcode.com/problems/number-of-subarrays-with-lcm-equal-to-k/">2470. Number of Subarrays With LCM Equal to K</a></h2><h3>Medium</h3><hr><div><p>Given an integer array <code>nums</code> and an integer <code>k</code>, return <em>the number of <strong>subarrays</strong> of </em><code>nums</code><em> where the least common multiple of the subarray's elements is </em><code>k</code>.</p>
